    ...
    @push('scripts')
        ...
        <script>
            (function() {
                ...
                function init() {
                    if (run()) { setTimeout(function() { initFinanceCharts(monthlyData, memberWiseData, categoryWiseData, savingsTrendData, accountBalanceTrends, incomeSourcesData, expensePatternsData); }, 500); return; }
                    var attempts = 0;
                    var t = setInterval(function() {
                        if (run()) { clearInterval(t); setTimeout(function() { initFinanceCharts(monthlyData, memberWiseData, categoryWiseData, savingsTrendData, accountBalanceTrends, incomeSourcesData, expensePatternsData); }, 500); return; }
