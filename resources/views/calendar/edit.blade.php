<x-app-layout title="Edit Event: {{ $family->name }}">
    <div class="space-y-6">
        ...
        <div class="bg-[var(--color-bg-primary)] rounded-xl shadow-lg border border-[var(--color-border-primary)] p-6">
            ...
            <x-form method="PATCH" action="{{ route('families.calendar.update', ['family' => $family->id, 'event' => $event->id]) }}" class="space-y-4">
                ...
                <div>
                    ...
                    <x-textarea id="description" name="description" rows="3" value="{{ old('description', $event->description) }}" class="mt-1 w-full" />
