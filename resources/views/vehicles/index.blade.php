                        ...
                        <div class="bg-[var(--color-bg-secondary)] rounded-lg border border-[var(--color-border-primary)] p-4 hover:shadow-md transition-shadow">
                            <div class="flex items-start justify-between">
                                ...
                                <div class="flex items-center gap-3 ml-4 flex-shrink-0">
                                    ...
                                    @can('delete', $vehicle)
                                        <button type="button" onclick="openDeleteModal({{ $vehicle->id }}, '{{ addslashes($vehicle->make) }} {{ addslashes($vehicle->model) }}', '{{ $vehicle->registration_number }}')" class="flex items-center gap-1.5 px-2 py-1.5 text-red-600 hover:text-red-700 hover:bg-red-50 rounded transition-colors border border-red-200" title="Delete Vehicle">
