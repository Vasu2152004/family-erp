...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div class="md:col-span-2">
        ...
        <x-textarea name="description" id="description" rows="3" value="{{ old('description', $medicine?->description ?? '') }}" placeholder="Additional notes or instructions..." class="mt-1" />
    ...
    <div>
        ...
        <x-error-message field="manufacturer" />
    </div>
    ...
    <div>
        ...
        <x-error-message field="batch_number" />
    </div>
    ...
    <div>
        ...
        <x-error-message field="min_stock_level" />
    </div>
    ...
    <div>
        ...
        <x-error-message field="purchase_price" />
    </div>
    ...
    <div>
        ...
        <x-select name="prescription_id" id="prescription_id" class="mt-1">
        ...
        <x-error-message field="prescription_id" />
    </div>
    ...
    <div class="md:col-span-2">
        ...
        <x-error-message field="prescription_file" />
