<x-app-layout title="Add Doctor Visit">
    <div class="space-y-6">
        <x-breadcrumb :items="[
            ...
            <x-form method="POST" action="{{ route('families.health.visits.store', ['family' => $family->id]) }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div id="cancellation_reason_field" class="md:col-span-2" style="display: none;">
                        ...
                        <textarea name="cancellation_reason" id="cancellation_reason" rows="2" class="mt-1 block w-full rounded-lg border border-[var(--color-border-primary)] px-4 py-2.5 text-[var(--color-text-primary)] bg-[var(--color-bg-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]">{{ old('cancellation_reason') }}</textarea>
                    ...
                    <div>
                        ...
                        <select name="visit_type" id="visit_type" required class="mt-1 block w-full rounded-lg border border-[var(--color-border-primary)] px-4 py-2.5 text-[var(--color-text-primary)] bg-[var(--color-bg-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]">
                            <option value="consultation" {{ old('visit_type', 'consultation') == 'consultation' ? 'selected' : '' }}>Consultation</option>
                ...
                <div id="completed_fields" class="space-y-6" style="display: none;">
                    <div>
                ...
                <div class="flex gap-4">
                    <x-button type="submit" variant="primary" size="md">Create Visit</x-button>
