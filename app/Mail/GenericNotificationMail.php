...
class GenericNotificationMail extends Mailable
{
    ...
    {
        $subject = htmlspecialchars($this->mailSubject, ENT_QUOTES, 'UTF-8');
        $body = htmlspecialchars($this->mailBody, ENT_QUOTES, 'UTF-8');
        $year = date('Y');
        ...
        <tr>
            ...
            <tr>
                <td style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 40px 40px 30px 40px; text-align: center;">
                    <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: 700;">Family ERP</h1>
                </td>
            </tr>
            <tr>
                <td style="padding: 40px;">
                    <div style="background-color: #f7fafc; border-left: 4px solid #667eea; padding: 20px; border-radius: 8px;">
                        <p style="margin: 0; color: #2d3748; font-size: 16px; line-height: 1.6;">{$body}</p>
                    </div>
                </td>
            </tr>
            <tr>
                <td style="background-color: #f7fafc; padding: 30px 40px; text-align: center; border-top: 1px solid #e2e8f0;">
                    <p style="margin: 0; color: #a0aec0; font-size: 12px;">© {$year} Family ERP. All rights reserved.</p>
                </td>
            </tr>
        </table>
            </td>
