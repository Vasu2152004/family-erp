...
function initInvestmentCharts(typeDistributionData, profitLossTrendData, ownerDistributionData, countByTypeData, valueTrendData) {
        ...
        try {
            ...
            setTimeout(function() {
                ...
                try {
                    ...
                    var chart = new ApexCharts(el, options); investmentChartInstances[key] = chart; chart.render();
    ...
    Object.keys(investmentChartInstances).forEach(key => {
        if (investmentChartInstances[key]) {
            investmentChartInstances[key].destroy();
            investmentChartInstances[key] = null;
        }
    });
